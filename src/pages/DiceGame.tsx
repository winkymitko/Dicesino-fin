...
import { Dice1, Dice2, Dice3, Dice4, Dice5, Dice6, Play, DollarSign, Trophy, Target } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900">
      ...
      <div className="absolute inset-0 opacity-10">
        <img 
          src="https://images.pexels.com/photos/37534/cube-six-gambling-play-37534.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop" 
          alt="Dice background"
      ...
      <div className="relative container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center items-center space-x-4 mb-4">
            <div className="w-12 h-12 bg-white rounded-lg shadow-xl flex items-center justify-center">
              <Dice1 className="h-8 w-8 text-red-600" />
            </div>
            <h1 className="text-4xl font-bold text-white">BarboDice</h1>
            <div className="w-12 h-12 bg-white rounded-lg shadow-xl flex items-center justify-center">
              <Dice6 className="h-8 w-8 text-red-600" />
            </div>
          </div>
        ...
        {!gameActive && !showResult && (
          <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6 mb-6">
            <h3 className="text-xl font-bold mb-4 text-white">Start New Game</h3>
            
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium mb-2 text-gray-300">Choose Stake</label>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 outline-none transition-colors text-sm text-white"
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-gray-300">Game Info</label>
            ...
            <button
              onClick={startGame}
              className="w-full mt-6 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 text-white font-bold py-3 rounded-lg transition-all duration-300 transform hover:scale-105"
            >
              Start Game - ${stake}
            </button>
          </div>
              ...
              {gameActive && !showResult ? (
                <>
                  <button
                    onClick={rollDice}
                    disabled={rolling}
                    className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 disabled:opacity-50 text-white font-bold py-3 rounded-lg transition-all flex items-center justify-center space-x-2"
                  >
                  ...
                  {canCashOut && (
                    <button
                      onClick={cashOut}
                      className="flex-1 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 text-white font-bold py-3 rounded-lg transition-all flex items-center justify-center space-x-2"
                    >
                ...
                <button
                  onClick={resetGame}
                  className="w-full bg-gradient-to-r from-yellow-600 to-yellow-700 hover:from-yellow-500 hover:to-yellow-600 text-white font-bold py-3 rounded-lg transition-all"
                >
                  Play Again
                </button>
              ) : null}
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6">
          <h3 className="text-xl font-bold mb-4 text-center text-white">Scoring & Multipliers</h3>
          
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-bold mb-3 text-gray-300">Scoring Rules</h4>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-400">Each 1:</span>
                  <span className="text-green-400 font-bold">100 pts</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Each 5:</span>
                  <span className="text-green-400 font-bold">50 pts</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Straight (1-2-3, 2-3-4, 1-3-5, 2-4-6):</span>
                  <span className="text-yellow-400 font-bold">100 pts</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Triple (n-n-n):</span>
            ...
            <div>
              <h4 className="font-bold mb-3 text-gray-300">Multipliers</h4>
              <div className="grid grid-cols-3 gap-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-400">50pts:</span><span className="text-green-400">1.1x</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">100pts:</span><span className="text-green-400">1.2x</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">150pts:</span><span className="text-yellow-400">1.3x</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">200pts:</span><span className="text-yellow-400">1.4x</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">250pts:</span><span className="text-orange-400">1.6x</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">300pts:</span><span className="text-orange-400">1.8x</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">400pts:</span><span className="text-red-400">2.0x</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">500pts:</span><span className="text-red-400">2.1x</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">600pts:</span><span className="text-purple-400">2.2x</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-gray-700 rounded-lg">
            <h4 className="font-bold mb-2 text-white">How to Play</h4>
