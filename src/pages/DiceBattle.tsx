      ...
      <div className="relative container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-white">DiceBattle</h1>
            <Swords className="h-8 w-8 text-red-500" />
          </div>
        ...
        {matchmaking && (
          <div className="bg-gray-800 border border-gray-700 rounded-2xl p-8 text-center mb-6">
            ...
            <h3 className="text-xl font-bold mb-2 text-white">Finding Opponent...</h3>
        ...
        {!gameActive && !matchmaking && !battleResult && (
          <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6 mb-6">
            <h3 className="text-xl font-bold mb-4 text-center text-white">Start Battle</h3>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-gray-300">Battle Info</label>
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-gray-300">Prize Pool</label>
                <div className="p-3 bg-green-900/30 border border-green-600 rounded-lg text-center">
                  <div className="text-lg font-bold text-green-400">
                    ${(stake * 2 * 0.95).toFixed(2)}
                  </div>
            ...
            <button
              ...
              className="w-full mt-6 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-bold py-3 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2"
            >
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6 mb-6">
            ...
            {!guessConfirmed ? (
              <>
                {/* Guess Slider */}
                <div className="mb-6">
                  <label className="block text-sm font-medium mb-2 text-center text-gray-300">Set Your Guess (3-18)</label>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white font-bold py-3 rounded-lg transition-all mb-6"
                >
              ...
              <>
                ...
                <button
                  onClick={rollDice}
                  disabled={rolling}
                  className="w-full bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-500 hover:to-orange-600 disabled:opacity-50 text-white font-bold py-3 rounded-lg transition-all flex items-center justify-center space-x-2"
                >
        ...
        {battleResult && (
          <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6 mb-6">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold mb-4 text-white">Battle Complete!</h3>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div className={`p-4 rounded-lg text-center ${
                battleResult.winner === 'opponent' ? 'bg-red-900/50 border border-red-500' : 'bg-gray-700 border border-gray-600'
              }`}>
                <div className="font-bold text-white">{battleResult.opponent.name}</div>
                <div className="text-sm text-gray-400">Guessed: {battleResult.opponent.guess}</div>
                <div className="text-sm text-gray-300">Distance: {battleResult.opponentDistance}</div>
                {battleResult.winner === 'opponent' && <Trophy className="h-6 w-6 text-yellow-400 mx-auto mt-2" />}
              </div>
              
              <div className={`p-4 rounded-lg text-center ${
                battleResult.winner === 'player' ? 'bg-green-900/50 border border-green-500' : 'bg-gray-700 border border-gray-600'
              }`}>
                <div className="font-bold text-white">You</div>
                <div className="text-sm text-gray-400">Guessed: {battleResult.playerGuess}</div>
                <div className="text-sm text-gray-300">Distance: {battleResult.playerDistance}</div>
